...
class Pproduct extends Model implements HasMedia
{
  ...
  {
      return $this->belongsToMany('App\Admin\Pdata\Application');
  }

  public function arapplications()
  {
      return $this->belongsToMany('App\Admin\Pdata\Arapplication');
  }

  public function fluids()
  {
      return $this->belongsToMany('App\Admin\Pdata\Fluid');
  }

  public function arfluids()
  {
      return $this->belongsToMany('App\Admin\Pdata\Arfluid');
  }
}
