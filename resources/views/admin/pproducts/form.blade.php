<div class="form-group">
    ...
    <div class="col-md-5">
        ...
        <datalist id="types">
            @foreach(\App\Models\Admin\Pproduct::groupBy('types')->select('types')->get() as $types)
...
<div class="form-group">
    ...
    <div class="col-md-5">
        ...
        <datalist id="category">
            @foreach(\App\Models\Admin\Pproduct::groupBy('category')->select('category')->get() as $category)
...
<div class="form-group">
    ...
    <div class="col-md-5">
        ...
        <datalist id="sub">
            @foreach(\App\Models\Admin\Pproduct::groupBy('sub')->select('sub')->get() as $sub)
